...
- Once again, due to `position: fixed`, there are some caveats with using modals on mobile devices. [See our browser support docs]({{ site.baseurl }}/docs/getting-started/browsers-devices/#modals-and-dropdowns-on-mobile) for details.
...
[Tooltips]({{ site.baseurl }}/docs/components/tooltips/) and [popovers]({{ site.baseurl }}/docs/components/popovers/) can be placed within modals as needed. When modals are closed, any tooltips and popovers within are also automatically dismissed.
